...
def composeMail():
    ...
    SpeakText("Mention the gmail ID of the person to whom you want to send a mail.")
    ...
    SpeakText("The mail will be sent to " +
...
def main():
    ...
    if EMAIL_ID != "" and PASSWORD != "":
        login = 1
        while (login) :
            SpeakText("Choose and speak out the option number for the task you want to perform. Say 1 to send a mail. Say 2 to get your mailbox status. Say 3 to search a mail. Say 4 to get the last 3 mails. Say 5 to logout.")
            ...
            if choice == '1' or choice.lower() == 'one':
                ...
                getLatestMails()
            elif choice == '5' or choice.lower() == 'five' or choice.lower() == 'faiv' :
                login = 0
...
if __name__ == '__main__':
    try :
        ...
        SpeakText("Wrong choice. Restarting!")
        main()
